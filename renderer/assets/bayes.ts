...
function inferir2(inf: any, inf2: any) {
  inferencia.evidence.setState(inf)
...
function inferir3(inf: any, inf2: any, inf3: any) {
  inferencia.evidence.setState(inf)
  inferencia.evidence.setState(inf2)
...
function inferir4(inf: any, inf2: any, inf3: any, inf4: any) {
  inferencia.evidence.setState(inf)
  inferencia.evidence.setState(inf2)
  inferencia.evidence.setState(inf3)
...
function inferir5(inf: any, inf2: any, inf3: any, inf4: any, inf5: any) {
  inferencia.evidence.setState(inf)
  inferencia.evidence.setState(inf2)
  inferencia.evidence.setState(inf3)
  inferencia.evidence.setState(inf4)
